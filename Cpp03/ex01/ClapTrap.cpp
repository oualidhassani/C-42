...
{
    std::cout << "Copy constructor is called ClapTrap " << std::endl;
...
{
    std::cout << "Copy assignement operator is called ClapTrap " << std::endl;
...
ClapTrap::~ClapTrap()
{
    std::cout << "destructor is called ClapTrap " << std::endl;
}
